...
public class SceneMgr : MonoSingleton<SceneMgr>
{
    ...
    #region 日志
    private void Log(string msg) => Debug.Log($"[SceneMgr] {msg}");
    private void LogWarning(string msg) => Debug.LogWarning($"[SceneMgr] {msg}");
    private void LogError(string msg) => Debug.LogError($"[SceneMgr] {msg}");
    #endregion
}
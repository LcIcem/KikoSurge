...
public class LobbyStartGame : MonoBehaviour
{
    ...
    private void OnEnterDungeon(long seed)
    {
        ...
        else
        {
            ...
            Debug.Log($"[LobbyStartGame] Selected role: index={roleIndex}, roleId={roleId}, roleName={roleData?.roleName ?? roleIndex.ToString()}");

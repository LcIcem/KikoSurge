...
public class CameraController : MonoBehaviour
{
    ...
    #region 日志
    private void Log(string msg) => Debug.Log($"[CameraController] {msg}");
    private void LogWarning(string msg) => Debug.LogWarning($"[CameraController] {msg}");
    private void LogError(string msg) => Debug.LogError($"[CameraController] {msg}");
    #endregion
}
}
